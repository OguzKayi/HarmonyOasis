<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ParcaDuzenle.aspx.cs" Inherits="HarmonyOasis.AdminPanel.ParcaDuzenle" ValidateRequest="false" %>
    ...
    <div class="formContainer">
        ...
        <div class="formContent">
            ...
            <asp:Panel ID="successful_pnl" CssClass="pnl_success" runat="server" Visible="false">
                <asp:Label ID="lbl_success" runat="server">Parça Düzenleme Başarılı</asp:Label>
            </asp:Panel>
            <div class="left">
                <div class="row">
                ...
                <div class="row">
                    ...
                    <asp:TextBox ID="tb_tarih" CssClass="form_tb" runat="server" TextMode="DateTime"></asp:TextBox>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <asp:Button ID="btn_ParcaDuzenle" class="formbutton" Text="Parça Düzenle" OnClick="btn_ParcaDuzenle_Click" runat="server" />
                </div>
            </div>
            <div class="right">
                <div class="row">
