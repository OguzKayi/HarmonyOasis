<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminMaster.Master" AutoEventWireup="true" CodeBehind="YorumListeKontrolYapilmadi.aspx.cs" Inherits="HarmonyOasis.AdminPanel.YorumListeKontrolYapilmadi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="formContainer">
        <div class="formTitle">
            <h3>Yorum Liste Kontrol Yapılmadı</h3>
        </div>
        <div class="kontrol">
            <div class="kontrol1">
        ...
        <div class="formContent">
            <asp:ListView ID="lv_kontrolyapilmadiYorumlar" OnItemCommand="lv_kontrolyapilmadiYorumlar_ItemCommand" runat="server">
                <LayoutTemplate>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:LinkButton ID="lbtn_kontrol" runat="server" CssClass="TableButtonDuzenle" CommandArgument='<%# Eval("ID") %>' CommandName="kontrol">Kontrol</asp:LinkButton>
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:ListView>
