<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AdminEkle.aspx.cs" Inherits="HarmonyOasis.AdminPanel.AdminEkle" %>
    ...
    <div class="formContainer">
        ...
        <div class="formContent">
            ...
            <asp:Panel ID="successful_pnl" CssClass="pnl_success" runat="server" Visible="false">
                <asp:Label ID="lbl_success" runat="server">Admin Ekleme Başarılı</asp:Label>
            </asp:Panel>
            <div class="left">
                <div class="row">
                ...
                <div class="row">
                    <asp:Button ID="btn_adminEkle" class="formbutton" Text="Admin Ekle" OnClick="btn_adminEkle_Click" runat="server" />
                </div>
            </div>
            <div class="right">
                <div class="row">
